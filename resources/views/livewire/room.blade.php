<div class="relative min-h-screen bg-cover bg-center overflow-x-hidden" style="background-image: url('{{ asset('images/room.jpg') }}');">
    ...
    <aside
        ...
        style="background-image: url('{{ asset('images/roomtexture.png') }}'); background-size: cover; background-repeat: no-repeat;">
