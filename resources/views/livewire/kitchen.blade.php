<div wire:poll.30s class="relative min-h-screen bg-cover bg-center overflow-x-hidden" style="background-image: url('{{ asset('images/kitchennn.jpg') }}');">
    ...
    <x-statspanel :statsList="$statsList" background="images/kitchentexture.png" />
